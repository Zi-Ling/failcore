    ...
    def __init__(
        ...
        Args:
            trace: Trace file path (.jsonl). Options:
                - "auto" (default): Auto-generate path .failcore/runs/<run_id>_<timestamp>/trace.jsonl
                - str: Custom path
        ...
        Example:
            >>> # Simplest usage - auto trace to .failcore/runs/
            >>> session = Session()
        ...
        if trace == "auto":
            # Generate: .failcore/runs/<run_id>_<timestamp>/trace.jsonl
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            run_dir = Path(f".failcore/runs/{self._run_id}_{timestamp}")
