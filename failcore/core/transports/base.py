# failcore/core/transports/base.py
"""
Base transport interface

Defines the contract between ToolRuntime and concrete transport implementations.
"""
...
from failcore.core.runtime.types import CallContext, ToolEvent, ToolResult, ToolSpecRef
