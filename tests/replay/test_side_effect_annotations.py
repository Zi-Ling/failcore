# tests/replay/test_side_effect_annotations.py
"""
...
from failcore.core.audit.side_effect_auditor import CrossingRecord
from failcore.core.audit.side_effects import SideEffectType
